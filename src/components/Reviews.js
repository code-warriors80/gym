  ...
  return (
               <div className=''>
                              ...
                              <div className='text-gray-400 lg:px-20 lg:w-[80%] mx-auto'>
                                             ...
                                             <p className='text-center lg:text-[18px] lg:font-bold px-5'>I have been a member of fitmas for over a year now, and it has been a game-changer for my fitness journey. The gym has fantastic range of equipmwnt that caters to all my workout needs</p>
